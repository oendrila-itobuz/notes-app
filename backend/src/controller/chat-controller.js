...
export const sendChat=async(req,res)=>{
 ...
 const data =await chatSchema.create({Sender:sender.userName,Receiver:receiver.userName,message:message,userId_Sender:senderId,userId_Receiver:receiverId})
 if (data) {
...
export const getChat=async(req,res)=>{
  ...
  const user = await chatSchema.find({$or: [
